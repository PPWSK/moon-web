...
class MissingChipIdError extends ESPError {
    constructor(message = "Security info command does not contain chip ID. " +
        "This is expected for ESP32-S2 which doesn't support chip ID in security info.") {
        super(message);
    }
}
export { ESPError, TimeoutError, UnsupportedCommandError, UnexpectedChipIdError, UnexpectedChipMagicError, MissingChipIdError, };
